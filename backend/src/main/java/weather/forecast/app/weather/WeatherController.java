...
import weather.forecast.app.api.GeographyApiFacade;
...
class WeatherController {
    ...
    private final SearchLogFacade searchLogFacade;
    private final GeographyApiFacade geographyApiFacade;

    @GetMapping("/today")
    public ResponseEntity<?> getWeatherThisWeek(@RequestParam(name = "lat") Double lat, @RequestParam(name = "lon") Double lon, Authentication authentication){
        try {
    ...
    public ResponseEntity<?> getWeeklySummary(@RequestParam(name = "lat") Double lat, @RequestParam(name = "lon") Double lon, Authentication authentication) {
        try {
            CoordinatesDto coords = new CoordinatesDto(lat, lon);
